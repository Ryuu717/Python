...
load_dotenv("/Users/Ryuuuu/Desktop/Solution+&+Completed+Code+day-60-end/.env")

posts = requests.get("https://api.npoint.io/c790b4d5cab58020d391").json()   #n:point https://www.npoint.io/
